...
// if(!mPhone.matches) { // for desktops
    ...
    function init() {
        ...
        if(!mPhone.matches) {
            ...
            // loadedGLTF.rotation.y = Math.PI/10;
        }
       ...
       // console.log(window.scrollY)
        ...
        if(window.scrollY > 50 && window.scrollY <= window.innerHeight) { // set less than value to anything till when the model scrolls
            ...
            if(changeDir) {
                ...
                GLTFOcta.rotation.y = window.scrollY/(window.innerHeight)*1.25 - changedAngle;
            }
